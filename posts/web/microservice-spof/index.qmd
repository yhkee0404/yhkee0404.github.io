...
그런데 @stanko2022single 는 @fig-microservice-spof-missing-microservice 과 같은 **Microservice**의 2가지 정상 동작 상태를 누락해 가용성을 $50\%$로 잘못 계산했고, **Monolith**의 가용성 $75\%$도 **소스코드** 내 의존성을 무시해서 잘못 비교했다.
