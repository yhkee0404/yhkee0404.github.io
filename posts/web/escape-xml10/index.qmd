...
categories:
  ...
  - StringEscapeUtils
  - "Apache Commons"
image: "스크린샷 2024-05-05 233633.png"
...
DB에서 조회되는 항목 중 일부를 Browser의 XML API 응답에서 찾을 수 없었다.
...
한편 [`EscapeXml11`](https://commons.apache.org/proper/commons-text/javadocs/api-release/src-html/org/apache/commons/text/StringEscapeUtils.html#line.168)도 있다. 그러나 DevSecOps Engineer @lee2012 에 따르면 XML 1.1은 권장되지 않는다. @mdnwebdocs2023 에 따르면 Browser 지원도 없다.