...
![3 / 3](/_images/pdf/yhkee0404-cv-ko-2025-05-12-3-3.png){group="fig-cv-or-resume-ko" fig-alt="A photo of page 3 of 3 of the CV."}
...
1. [소스코드를 확인](https://github.com/yhkee0404/yhkee0404.github.io/blob/main/cv/ko/index.qmd)한 다음

2. [이 저장소를 포크](https://github.com/yhkee0404/yhkee0404.github.io/fork)하고

3. [GitHub Pages](https://quarto.org/docs/publishing/github-pages.html#source-branch)로 배포해보세요.
...
관련 포맷을 빠르게 파악할 수 있지만 [see @king_ticketmaster_search], 렌더링 성능 이점은 없습니다.
