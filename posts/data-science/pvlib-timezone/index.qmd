...
image: james-lee-4ujY2rb7KOQ-unsplash.png
---
...
Timezone은 Offset 수만으로 충분히 비교할 수 있지만 같은 수라도 편의상 다른 지명 등의 이름을 붙일 수 있다. IANA(Internet Assigned Numbers Authority)에서 [Time Zone Database](https://iana.org/time-zones/)를 관리하고 있다. 줄여서 tz나 zoneinfo라 부른다.
