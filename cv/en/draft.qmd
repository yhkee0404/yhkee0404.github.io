...
Java | Spring Framework | Python | Django REST Framework | FastAPI | JavaScript | Apache Airflow | Celery | Amazon DynamoDB | PostgreSQL | Oracle | GitHub Actions | Maven | Terraform Cloud | AWS IAM | SSH Tunneling 
...
Optimized coordinate transformation by reverse engineering (47 s &rarr; 14 &micro;s, float32 → float64, 99.55% → 100%)
...
Developed an **internet-based** [grievance service][ndts] and **intranet** services for educational assessment ([**exceptional award**](https://yhkee0404.github.io/_images/portrait/navy.jpg)), mental health assessment, and attendance management, fixing [missing rows][escape-xml10] (Spring Framework, Oracle)
